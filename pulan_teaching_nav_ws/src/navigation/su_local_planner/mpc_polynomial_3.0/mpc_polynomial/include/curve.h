...
public:
   ...
   */
  virtual bool run(const Points2d points, Points2d& path,nav_msgs::Path&desired_path) = 0;
   ...
   * @return true if generate successfully, else failed
   */
  virtual bool run(const Poses2d points, Points2d& path,nav_msgs::Path&desired_path) = 0;
